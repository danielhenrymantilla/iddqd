...
///
/// "User call" means anything that decrements the shared countdown:
///
/// * Key accesses.
...
/// made at most `n` user calls. With `armed = None`, no panic should escape.
...
/// observe mode is off.)
///
/// The output is a TSV with columns: map label, action label, observed
/// user-call count.
